...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID,Email,Password from tblowner where  Email='$owemail'");
    $row = mysqli_fetch_assoc($query);
    $hashpass = $row["Password"];
    $ret = $row["ID"];
    $verify=password_verify($password,$hashpass);
    if($verify){
    $_SESSION['pgasoid']=$ret;
    $cookie_name['pgasoid']=$ret;
    $cookie_value = $ret;
...
<!DOCTYPE html>
<head>
<title>Atudent Accomodation| Owner Login </title>
