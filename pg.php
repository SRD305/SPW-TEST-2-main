		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-md-10 header-text">
					<h1>Student Housing in Ireland</h1>
					<p>
						...
						<div class="desc">
							...
							<div class="middle">
								<div class="d-flex justify-content-start">
									<p>Heater: <span class="gr"><?php echo $row['AC'];?></span></p>
							...
							<div class="bottom d-flex justify-content-start">
								<p><span class="lnr lnr-star"></span> <?php echo $row['CityName'];?></p>
								<p><span class="lnr lnr-star"></span> <?php echo $row['County'];?></p>
							</div>
						</div>
					</div>
				</div>
