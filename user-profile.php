...
if (strlen($_SESSION['pgasuid']==0)) {
  ...
  echo htmlspecialchars($mobilenumber, ENT_QUOTES, 'UTF-8');
  $email=$_POST['email'];
  echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8');
  $fathername=$_POST['fathername'];
  echo htmlspecialchars($fathername, ENT_QUOTES, 'UTF-8');
  $dob=$_POST['dob'];
  $comaddress=$_POST['comaddress'];
  echo htmlspecialchars($comaddress, ENT_QUOTES, 'UTF-8');
    $emergencynumber=$_POST['emergencynumber'];
    echo htmlspecialchars($emergencynumber, ENT_QUOTES, 'UTF-8');
